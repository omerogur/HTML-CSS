...
if(examGrade<=100 && examGrade>=90){
    ...
    textInfo="AA"
}else if(examGrade<=89 && examGrade>=85){

    textInfo="BB"
}else if(examGrade<=79 && examGrade>=75){

    textInfo="CB"
}
else if(examGrade<=74 && examGrade>=70){

    textInfo="CC"
}else if(examGrade<=69 && examGrade>=65){

    textInfo="DC"
}else if(examGrade<=64 && examGrade>=60){
    ...
    textInfo="LÜTFEN 0-100 arası not giriniz"
}
